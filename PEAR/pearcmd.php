 ...
 * @nodep Gtk
 */
if ('/hsphere/local/home/gretha53/diecasthobbyshop.com/nzbed/PEAR' != '@'.'include_path'.'@') {
    ini_set('include_path', '/hsphere/local/home/gretha53/diecasthobbyshop.com/nzbed/PEAR');
    $raw = false;
} else {
